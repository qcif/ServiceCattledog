	...
	<body>
		...
		<div id="show-locationType" class="content scaffold-show" role="main">
			...
			<ol class="property-list locationType">
				...
				<g:if test="${locationTypeInstance?.title}">
				<li class="fieldcontain">
					<span id="title-label" class="property-label"><g:message code="locationType.title.label" default="Title" /></span>
					
						<span class="property-value" aria-labelledby="title-label"><g:fieldValue bean="${locationTypeInstance}" field="title"/></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${locationTypeInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
