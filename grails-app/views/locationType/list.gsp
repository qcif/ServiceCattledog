			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="title" title="${message(code: 'locationType.title.label', default: 'Title')}" />
				...
				<g:each in="${locationTypeInstanceList}" status="i" var="locationTypeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${locationTypeInstance.id}">${fieldValue(bean: locationTypeInstance, field: "title")}</g:link></td>
